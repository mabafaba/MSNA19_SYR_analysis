...
map_to_hierarchical_template<-function(results, by_analysisplan_columns = c("dependent.var",
                                                                            "repeat.var",
                                                                            "repeat.var.value",
                                                                            "independent.var",
  ...
  hypegrammaR:::map_to_generic_hierarchical_html(results,
                                                 ...
                                                 by_prefix =  rep("",length(by_analysisplan_columns)),
                                                 level = 2,
...
map_to_raw_summary_table<-function(results){
